...
<div class="card">
    <div class="card-body">
      <h5 class="card-title">Dear {{ Session::get('fusername') }},</h5>
      <p class="card-text">Welcome to @if($company->cmp_name != '') {{ $company->cmp_name }} @else Company @endif</p>
    </div>
  </div>
  <h3>Demo Reports</h3>
  <div class="row">
                    ...
                    <table class="table table-borderless table-hover table-nowrap align-middle mb-0">
                        ...
                        <tbody>
                            <tr>
                                <td>Absternet LLC</td>
                                <td>Sep 20, 2021</td>
                                <td><img src="{{ asset('public/dashboard/assets/images/users/avatar-1.jpg') }}" alt="" class="avatar-xs rounded-circle me-2">
                                ...
                                <div class="avatar-group">
                                    <div class="avatar-group-item">
                                        <a href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Stine Nielsen">
                                            <img src="{{ asset('public/dashboard/assets/images/users/avatar-1.jpg') }}" alt="" class="rounded-circle avatar-xxs">
                                        </a>
                                    </div>
                                    <div class="avatar-group-item">
