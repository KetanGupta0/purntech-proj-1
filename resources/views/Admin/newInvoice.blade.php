...
{{-- {{ dd($user) }} --}}
    <form action="{{ url('/admin/user-invoices-page/raise-new-invoice/form-submit') }}" method="POST" id="raise-new-invoice" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-md-12">
                <textarea class="form-control" name="customer_message" id="customer_message" style="width: 100%" rows="5">JIO welcomes you. We are pleased to inform you that your application for the installation of a JIO tower has been accepted. The address mentioned by you has been secretly verified by the company team. Below are the details as captured in JIO's records. Please review carefully and inform us immediately of any discrepancies.</textarea>
            </div>
        </div>
